...
if(isset($_POST['submit']))
{
  ...
  $lname=$_POST['lname'];
	...
	if($num>1)
	{
	$_SESSION['msg']="Email Address already registered with us";	
	}
	else
	{
 mysqli_query($con,"insert into user(firstname,lastname,email,password,mobile,gender) values('$fname','$lname','$email','$password','$mobile','$gender')");
    ...
    {      
     var flag=0; 
		   if(document.getElementById('fname').value=="")
            {
            document.getElementById('errfname').innerHTML="*Firstname field is empty.";
            flag=1;
         ...
         if(document.getElementById('lname').value=="")
            {
            document.getElementById('errlname').innerHTML="*Lastname field is empty.";
            flag=1;
...
<div class="container">
  <div class="row login-container column-seperation">  
        ...
        <h2>Sign in to VIJU MILK CRM</h2>
          <p><a href="index.php">Sign in Now!</a> for a Customer account, It's free and always will be..</p>
          <br>
        ...
        <p style="color:#F00"><?php echo $_SESSION['msg'];?><?php echo $_SESSION['msg']="";?></p>
		 ...
		 <div class="form-group col-md-10">
            ...
            <div class="controls">
                ...
                <span class="help-block"><div style="color:#F00;" id="errlname"></div></span>
            </div>
          </div>
          </div>
           <div class="row">
