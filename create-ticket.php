...
$a=mysqli_query($con,"insert into ticket(ticket_id,user_id,subject,task_type,prioprity,ticket,status,posting_date)  values('$tid','$userid','$subject','$tt','$priority','$ticket','$st','$pdate')");
if($a)
{
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                               ...
                               <div class="form-group">                                        
									 ...
									 <div class="form-group">
                                        <label class="col-md-3 col-xs-12 control-label">Ticket Category</label>
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                                <?php 
                                        $query=mysqli_query($con,"select * from ticket_category ORDER BY Id ASC");                        
                                        $count = mysqli_num_rows($query);
                                        if($count > 0){                       
                                            echo ' <select required name="tasktype" class="form-control select">';
                                            echo'<option> Select your Ticket Category</option>                                            ';
                                        ...
                                        <div class="col-md-6 col-xs-12">                                                                                            
                                            <select name="priority" required class="form-control select">
