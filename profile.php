...
if(isset($_POST['update']))
{
	...
	$a=mysqli_query($con,"update user set firstname='$fname',lastname='$lname',mobile='$mobile',gender='$gender',alt_email='$aemail',address='$address' where email='".$_SESSION['login']."'");
if($a)
{
