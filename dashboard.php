		...
		<div class="page-title">	
          ...
          <div class="col-md-3 col-sm-6 spacing-bottom-sm spacing-bottom">
            <div class="tiles blue added-margin">
              <div class="tiles-body">
				...
				?>
                <div class="heading"> <span class="animate-number" data-value="<?php echo $num;?>" data-animation-duration="1200">0</span>| <a href="view-tickets.php" style="color:#FFF"> All Tickets </a></div>
          ...
          <div class="col-md-3 col-sm-6 spacing-bottom-sm spacing-bottom">
            <div class="tiles green added-margin">
              <div class="tiles-body">
                <div class="controller"> <a href="javascript:;" class="reload"></a> <a href="javascript:;" class="remove"></a> </div>
                <?php $rets=mysqli_query($con,"select * from ticket where status != 'Closed' and user_id='".$_SESSION['id']."'");
				$nums=mysqli_num_rows($rets);
				?>
                <div class="heading"> <span class="animate-number" data-value="<?php echo $nums;?>" data-animation-duration="1200">0</span>| <a href="view-tickets.php" style="color:#FFF"> Pending Tickets </a></div>
