  ...
  <div class="page-sidebar" id="main-menu">
    ...
    <div class="page-sidebar-wrapper scrollbar-dynamic" id="main-menu-wrapper">
      <div class="user-info-wrapper">
        <div class="profile-wrapper"> <img src="<?php if($_SESSION['gender'] == "Female"){echo "./assets/img/others/avatarF.png";}else{echo "./assets/img/others/avatarM.png";}?>"  alt=""  width="69" height="69" /> </div>
        <div class="user-info">
    ...
    <ul>	
      <li class="active"> <a href="dashboard.php"> <i class="icon-custom-home"></i> <span class="title">Dashboard</span> <span class="selected"></span>  </a> 
		    </li>
