                ...
                <div class="tiles-title text-black">Overall Tickets </div>
                    ...
                    <div class="widget-stats ">
					  ...
					  ?>
						...
						<span class="item-title">Open Tickets</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $otv1;?>" data-animation-duration="700">0</span> <?php									
					...
					<div class="widget-stats ">
                      <div class="wrapper last"> 
					   ...
					   $tdate=date("Y/m/d");
					    ...
					    $otvv=mysqli_query($con,"select * from ticket where status='In-Progress'");
					  $otv1v=mysqli_num_rows($otvv);
					  ?>
									
									
						
						<span class="item-title">In-Progress Tickets</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $otv1v;?>" data-animation-duration="700">0</span> <?php									
					...
					<div class="widget-stats ">
					  ...
					  ?>
						...
						<span class="item-title">Closed Tickets</span> <span class="item-count animate-number semi-bold" data-value="<?php echo $otv1;?>" data-animation-duration="700">0</span> <?php									
