...
$pdate=date('Y-m-d');
$a=mysqli_query($con,"insert into ticket_category(categoryName,description,dateCreated)values('$categoryName','$description','$pdate')");
if($a)
{
echo "<script>alert('Ticket Category Created Successfully!');</script>";
}
}
?>
...
<meta charset="utf-8" />
<title>CRM | Create  ticket category</title>
                               ...
                               <div class="form-group">                                        
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <div class="input-group">
                                                ...
                                                <input type="text" name="categoryName" id="categoryName" value="" required class="form-control"/>
                                            </div>            
